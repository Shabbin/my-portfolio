    ...
    <div className="relative xl:mt-12">
      ...
      <div
        className="
          ...
          flex xl:flex-row flex-col-reverse gap-10
          overflow-hidden
        "
      >
        {/* =====================
            LEFT — FORM WITH ELECTRIC BORDER
        ===================== */}
        <motion.div
        ...
        >
          ...
          >
            <div
              className="
                bg-[#020617]/80 rounded-2xl p-8
                backdrop-blur-sm
                border border-[rgba(15,23,42,0.9)]
              "
              style={{
              ...
              >
                <label className="flex flex-col">
                  ...
                  <input
                    ...
                    className="
                      bg-[#020617] py-4 px-5 rounded-lg
                      text-white placeholder:text-slate-500
                      border border-slate-700/60
                      focus:border-[rgba(34,197,94,0.8)]
                    "
                  />
                </label>
                ...
                <motion.button
                  ...
                  whileHover={{
                    scale: 1.03,
                    boxShadow: `0 0 18px ${ACCENT_HEX}`,
                  }}
                  whileTap={{ scale: 0.97 }}
                  className="
                    mt-2 rounded-xl py-3 px-8
                    font-bold text-[14px]
                    text-[#020617]
                  "
                  style={{
                    background: ACCENT_HEX,
                    boxShadow: `0 0 14px ${ACCENT_HEX}`,
                  }}
                >
