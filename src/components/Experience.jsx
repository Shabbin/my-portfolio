  ...
  return (
    ...
    >
      <ElectricBorder
        ...
        className="w-full"
      >
        <article className="relative rounded-2xl bg-[#020617]/95 px-5 py-6 sm:px-7 sm:py-7 overflow-hidden">
          <div
            className="pointer-events-none absolute inset-x-0 top-0 h-[2px]"
            style={{
              background: `linear-gradient(to right, transparent, ${ACCENT_HEX}, transparent)`,
              boxShadow: `0 0 10px ${ACCENT_HEX}`,
            }}
          />

          <div className="flex items-start gap-4">
            <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-slate-900 flex items-center justify-center shadow-[0_0_20px_rgba(34,197,94,0.7)]">
              <img
                src={experience.icon}
